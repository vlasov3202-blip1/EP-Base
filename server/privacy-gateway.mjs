...
export class PrivacyGateway{
  ...
  async prepare({input={},providerId=null,capability=null,metadata={}}={}){
    ...
    const prepared=this.sanitizeContext(input);
    return {...prepared,__privacy:{providerId,capability,rawMediaForwarded:false,minimumNecessary:true,metadata:this.sanitizeContext(metadata)}};
  }
}
